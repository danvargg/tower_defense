"""Game constants."""
from structlog import get_logger  # TODO: what is this logger doing
import glob  # TODO: can all pg stuff be imported in init? or at least the fixed / init / basic ones?
from itertools import chain
from typing import Dict, Tuple
from pygame import Rect as pg_rect, Surface as pg_surface  # TODO: review all constants
...
SCREEN_RECT = pg_rect(0, 0, TILE_WIDTH * TILES_X, TILE_HEIGHT * TILES_Y)  # FIXME: (0, 0) magic numbers

DESIRED_FPS = 60

log = get_logger()  # TODO: why is this needed?
...
# right direction.
VISION_RECT = pg_rect(0, 0, 32, 400)
...
IMAGE_SPRITES: Dict[Tuple[bool, bool, str], pg_surface] = {}
